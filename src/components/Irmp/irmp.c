...
#  define ANALYZE_PUTCHAR(a)                    { if (! silent)             { putchar (a);          } }
#  define ANALYZE_ONLY_NORMAL_PUTCHAR(a)        { if (! silent && !verbose) { putchar (a);          } }
#  define ANALYZE_PRINTF(...)                   { if (verbose)              { log_uart_printf(UART1,__VA_ARGS__); } }
#  define ANALYZE_PRINTF1(a)                    { if (verbose)              { log_uart_printf(UART1, a);} }
#  define ANALYZE_PRINTF2(a,b)                  { if (verbose)              { log_uart_printf(UART1, a,b); } }
#  define ANALYZE_PRINTF3(a,b,c)                { if (verbose)              { log_uart_printf(UART1, a,b,c); } }
#  define ANALYZE_PRINTF4(a,b,c,d)              { if (verbose)              { log_uart_printf(UART1, a,b,c,d); } }
#  define ANALYZE_PRINTF5(a,b,c,d,e)            { if (verbose)              { log_uart_printf(UART1, a,b,c,d,e); } }
#  define ANALYZE_PRINTF6(a,b,c,d,e,f)          { if (verbose)              { log_uart_printf(UART1, a,b,c,d,e,f); } }
#  define ANALYZE_PRINTF7(a,b,c,d,e,f,g)        { if (verbose)              { log_uart_printf(UART1, a,b,c,d,e,f,g); } }
#  define ANALYZE_PRINTF8(a,b,c,d,e,f,g,h)      { if (verbose)              { log_uart_printf(UART1, a,b,c,d,e,f,g,h); } }
#  define ANALYZE_PRINTF9(a,b,c,d,e,f,g,h,i)    { if (verbose)              { log_uart_printf(UART1, a,b,c,d,e,f,g,h,i); } }
#  define ANALYZE_ONLY_NORMAL_PRINTF1(a)        { if (! silent && !verbose) { log_uart_printf(UART1, a); } }
#  define ANALYZE_NEWLINE()                     { if (verbose)              { log_uart_printf(UART1, "\n"); } }
static int                                      silent = 1;
static int                                      time_counter;
...
#elif defined(ARM_MM32F013X)                                            // MM32F013X
    drv_gpio_pin_mode(IRMP_PIN, GPIO_MODE_INPUT_NONE);                  // pin is input
